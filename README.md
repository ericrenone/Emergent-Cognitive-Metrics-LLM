...
Visualizes emergent metrics such as **logic**, **aesthetic**, **understanding**, and **utility** from a stochastic token stream.


This simulation demonstrates that simple, stochastic cognitive dynamics can produce emergent, interpretable metrics of logic, aesthetic sensitivity, understanding, and utility.
